 ...
 ***********************************************************************/
function __peach_l() { 
__sprite_init__(this, peach_l, 184, 292, 92, 280, 'Box', 92, 10, 174, 0, 282, ['img/peach_l_0.png']);
}; var peach_l = new __peach_l();

function __sprite_12() { 
__sprite_init__(this, sprite_12, 335, 310, 0, 0, 'Box', 167, 0, 335, 0, 310, ['img/sprite_12_0.png']);
}; var sprite_12 = new __sprite_12();

function __peach_r() { 
__sprite_init__(this, peach_r, 184, 292, 92, 280, 'Box', 92, 0, 184, 0, 292, ['img/peach_r_0.png']);
}; var peach_r = new __peach_r();

function __peach_b() { 
__sprite_init__(this, peach_b, 184, 292, 92, 280, 'Box', 92, 0, 184, 0, 292, ['img/peach_b_0.png']);
}; var peach_b = new __peach_b();

function __table() { 
__sprite_init__(this, table, 1000, 300, 500, 150, 'Box', 500, 55, 955, 130, 290, ['img/table_0.png']);
}; var table = new __table();

function __kitchen_bg() { 
__sprite_init__(this, kitchen_bg, 900, 472, 0, 0, 'Box', 450, 0, 900, 0, 472, ['img/kitchen_bg_0.png']);
}; var kitchen_bg = new __kitchen_bg();
...
__background_init__(this, background_4, 'img/money_header_06.jpg')}; var background_4 = new __background_4();

function __background_34() { 
__background_init__(this, background_34, 'img/yellow_backdrop.png')}; var background_34 = new __background_34();
 ...
 * OBJECTS
 ***********************************************************************/
function __obj_peach() {
__instance_init__(this, obj_peach, null, 1, 10, peach_r, 1, 0);
...
if ( keyboard_check( vk_right )) { 
    sprite_index = peach_r;
	x = x + 5; 
}

if ( keyboard_check( vk_left )) { 
	sprite_index = peach_l;
    x = x - 5; 
}
...
if ( keyboard_check( vk_down ) && y < 710) {
	sprite_index = peach_r;
    y = y + 5; 
}
}
...
}; var obj_peach = new __obj_peach();

function __object_13() {
__instance_init__(this, object_13, null, 1, 0, sprite_12, 0, 1);
this.on_creation = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var object_13 = new __object_13();

function __obj_table() {
__instance_init__(this, obj_table, null, 1, 0, table, 1, 4);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var obj_table = new __obj_table();

function __object_35() {
__instance_init__(this, object_35, null, 1, 20, kitchen_bg, 0, 6);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = on_step_i;
this.on_end_step = on_end_step_i;
...
this.objects = [
[{o:obj_peach, x:140, y:660}],
[{o:object_13, x:2600, y:120}],
[{o:obj_table, x:500, y:620}],
[{o:object_35, x:0, y:260}],
[{o:object_35, x:900, y:260}],
[{o:object_35, x:1800, y:260}]];
this.start = function() {
__room_start__(this, scene_5, 3000, 780, 45, 0, 0, 0, background_34.image, 0, 0, 1, 1600, 780, obj_peach, 1000, 1000);
};
}
